...
xhr.open('GET', 'admin/php/data.json', false);
xhr.send();
if (xhr.status != 200) {
  ...
  RedRaspis1Group = jsonData.RedRaspis1Group;
  RedRaspis2Group = jsonData.RedRaspis2Group;
  RedRaspis3Group = jsonData.RedRaspis3Group;
  RedRaspis4Group = jsonData.RedRaspis4Group;
  GreenRaspis1Group = jsonData.GreenRaspis1Group;
  GreenRaspis2Group = jsonData.GreenRaspis2Group;
  GreenRaspis3Group = jsonData.GreenRaspis3Group;
  GreenRaspis4Group = jsonData.GreenRaspis4Group;
...
// var writeData = new XMLHttpRequest();
// writeData.open('POST', 'php/write.php', false);
// writeData.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
// jsonData.greenWeek[0] = [34,34];
// writeData.send('key='+JSON.stringify(jsonData,null,2));
// if (writeData.status != 200) {
//   console.log( writeData.status + ': ' + writeData.statusText );
// } else {
    
//   console.log(JSON.parse(writeData.responseText));
// }

// async function lol(){
//      let response = await fetch('php/write.php', {
//   method: 'POST',
//   body: {key: 'lol'}
// });
