...
var RedWeek = [																		//	
	...
	[1,2,3,4,5,13,14,15,16,17,18,19,27,28,29,30,31],								//
	[],																				//
	[],																				//
	[],																				//
	[],								                                            	//
...
['Системное программ-е(211)/Дмитренко Павел Сергеевич','Алгоритмы и методы(116)/Горская Ирина Юрьевна'],											
...
[,'Философия(315)/Мезенцев Ю.Л.','Базы данных(123)/Высочин','Системное программ-е(121)/Дмитренко Павел Сергеевич','Физ-ра'],		
[],																					
[]																					
];																					
...
['Системное программ-е(211)/Дмитренко Павел Сергеевич','Компьютерные сети(224)/Зуев Сергей Александрович'],									
['Компьютерные сети(211)/Зуев Сергей Александрович','Философия(302)/Величко С.А.'],											
['Базы данных(123)/Высочин С.В.','Теория вероятности(211)/Цветков Д.О.'],											
['Компьютерная графика(8)/Михерский Ростислав Михайлович','Философия(315)/Мезенцев Ю.Л.','Системное программ-е(121)/Дмитренко Павел Сергеевич','Базы данных(123)/Высочин С.В.','Физ-ра'],		
[],																					
[]																					
];																					
...
['Алгоритмы и методы(211)/Милюков Виктор Васильевич','Схемотехника(411Б)/Григорьев Евгений Владимирович','Компьютерные сети(224)/Зуев Сергей Александрович','Кураторский час(8)/Корниенко Андрей Юрьевич'],							//
['Системное программ-е(211)/Дмитренко Павел Сергеевич','Теория вероятности(211)/Цветков Д.О.','Алгоритмы и методы(116)/Горская И.Ю.'],									//
['Компьютерная графика(211)/Михерский Ростислав Михайлович','Экономика(302)/Романюк Е.В.','Экономика(211)/Нистиренко Е.С.'],															//
['Компьютерная графика(8)/Михерский Ростислав Михайлович','Базы данных(211)/Высочин С.В.','Базы данных(123)/Высочин С.В.'],											//
['Базы данных(123)/Высочин С.В.','Системное программ-е(121)/Дмитренко Павел Сергеевич',,,'Физ-ра'],						//
[],																					
[]																					
];																					
...
['Алгоритмы и методы(211)/Милюков Виктор Васильевич','Схемотехника(411Б)/Григорьев Евгений Владимирович','Алгоритмы и методы(116)/Горская И.Ю.','Кураторский час(8)/Корниенко Андрей Юрьевич'],													
['Системное программ-е(211)/Дмитренко Павел Сергеевич','Теория вероятности(211)/Цветков Д.О.'],											
['Компьютерная графика(211)/Михерский Ростислав Михайлович','Экономика(302)/Романюк Е.В.','Экономика(211)/Нистиренко Е.С.'],															
['Компьютерные сети(224)/Зуев Сергей Александрович','Базы данных(211)/Высочин С.В.'],											
['Системное программ-е(121)/Дмитренко Павел Сергеевич','Базы данных(123)/Высочин С.В.',,,'Физ-ра'],
[],																					
[]																					
];																					
